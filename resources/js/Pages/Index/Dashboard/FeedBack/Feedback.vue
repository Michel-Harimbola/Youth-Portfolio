    ...
    <DashLayout >
        <div class="p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center">
                <h2 class="text-5xl font-black text-bleu">Feedback</h2>
                <Link href="/Login/Dashboard/Feedback/AddFeedback" class="font-bold text-xl px-8 py-3 bg-fuchsia text-white rounded-md hover:scale-105 duration-300">Ajouter</Link>
            </div>
