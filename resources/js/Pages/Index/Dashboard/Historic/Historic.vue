    ...
    <DashLayout >
        <div class="p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center">
                <h2 class="text-5xl font-black text-blue-950">Historic</h2>
                <Link href="/Login/Dashboard/Historic/AddHistoric" class="px-8 py-3 text-xl font-bold bg-red-500 text-white rounded-md hover:bg-red-400">Add Historic</Link>
            </div>
            ...
            <div class="mt-6">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xl font-black text-white uppercase tracking-wider">Location</th>
