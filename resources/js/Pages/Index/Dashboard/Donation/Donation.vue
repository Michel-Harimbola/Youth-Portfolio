    ...
    <DashLayout >
        <div class="p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center">
                ...
                <Link href="/Login/Dashboard/Donation/AddDonation" class="px-8 py-3 text-xl font-bold bg-fuchsia text-white rounded-md hover:scale-105 duration-300">Ajouter</Link>
            </div>
            ...
            <div class="mt-6">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xl font-black text-white tracking-wider">Montant</th>
